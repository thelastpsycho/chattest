  ...
  return (
    <div className="space-y-4">
      <div className="bg-[var(--anvaya-white)] border border-[var(--anvaya-light-gray)] rounded-xl p-6 shadow-sm">
        <h3 className="text-lg mb-4">Add-On Services</h3>
        <p className="text-sm text-gray-600 mb-4">
          Select any services you'd like to add to your stay. You can also skip this and add later.
        </p>
